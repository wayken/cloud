...
import cloud.apposs.webx.interceptor.limit.LimitRateException;
...
public class StandardExceptionResolver extends MappingExceptionResolver<HttpServletRequest, HttpServletResponse> {
    public StandardExceptionResolver() {
        ...
        this.addExceptionHandler(new LimitRateExceptionHandler());
    ...
    class IllegalAccessExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
    ...
    class LimitRateExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
            return LimitRateException.class;
        }
    ...
    class SQLExceptionHandler implements ExceptionHandler<HttpServletRequest, HttpServletResponse> {
        @Override
        public Class<? extends Throwable> getExceptionType() {
