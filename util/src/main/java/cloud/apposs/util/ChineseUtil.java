...
public final class ChineseUtil {
    protected static String GENERIC_CHINESE_WORD =
    ...
    /**
     * 获取指定文字的随机中文
     * 汉字一、二级字库的汉字与unicode编码(十六进制)对照表:
     * https://blog.csdn.net/zhoukejun/article/details/1937372
     */
    public static String getSimpleChineseWord() {
        return GENERIC_CHINESE_WORD.charAt(new Random().nextInt(GENERIC_CHINESE_WORD.length())) + "";
    }
     ...
     * https://blog.csdn.net/zhoukejun/article/details/1937372
     */
    public static String getRandomChineseWord() {
