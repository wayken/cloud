...
@Component
public class RequestParameterResolver implements ParameterResolver<BootorHttpRequest, BootorHttpResponse> {
    @Override
    public boolean supportsParameter(Parameter parameter) {
        return BootorHttpRequest.class.isAssignableFrom(parameter.getType());
    }
