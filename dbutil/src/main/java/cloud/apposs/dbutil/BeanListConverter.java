...
public class BeanListConverter<T> implements ResultSetConverter<List<T>> {
    ...
    public BeanListConverter(Class<T> type) {
        this.type = type;
    }
    ...
    private List<T> toBeanList(ResultSet rs, Class<T> type2) throws SQLException {
