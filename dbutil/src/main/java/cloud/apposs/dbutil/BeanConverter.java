...
public class BeanConverter<T> implements ResultSetConverter<T> {
	...
	public BeanConverter(Class<T> type) {
		this.type = type;
	}

	@Override
	public T convert(ResultSet rs) throws SQLException {
		return rs.next() ? toBean(rs, this.type) : null;
	}

	public T toBean(ResultSet rs, Class<T> type) throws SQLException {
	...
	private T newInstance(Class<T> c) throws SQLException {
		try {
